...
CLIENT_ID = os.getenv('7588002866610145')
CLIENT_SECRET = os.getenv('T9ueuIVjoLRjlJkfBQQwi4V8UqtebAWf')
REDIRECT_URI = os.getenv('REDIRECT_URI', 'https://app-ml-ffds.onrender.com/api/ml/callback')
